# ALM OpenAPI Specification
[![Build Status](https://travis-ci.org/mmrao12/APIHUB.svg?branch=master)](https://travis-ci.org/mmrao12/APIHUB)
...
6. If you did everything correct, https://mmrao12.github.io/APIHUB/ will lead to your new docs
...
- Documentation(ReDoc): https://mmrao12.github.io/APIHUB/
- SwaggerUI: https://mmrao12.github.io/APIHUB/swagger-ui/
- Look full spec:
    + JSON https://mmrao12.github.io/APIHUB/swagger.json
    + YAML https://mmrao12.github.io/APIHUB/swagger.yaml
- Preview spec version for branch `[branch]`: https://mmrao12.github.io/APIHUB/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mmrao12.github.io/APIHUB/ with url from the message: `Server started <url>`
